...
- **[An installable Codex plugin](https://github.com/outagedeck/codex-plugins)** that bundles the MCP server with a dependency-outage triage skill. Add the public marketplace with `codex plugin marketplace add outagedeck/codex-plugins`; it is validated against the live 14-tool MCP contract.
